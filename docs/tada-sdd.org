...
* TODO Next up (rough prio order) [7/16]
- [ ] install all python in github and PyPI in pythonic way
  + use wheel
  + universal format
  + see "distributing" check-list

- [ ] mock ingest should save info (to confirm it worked),
  + provide random prob of failure to simulate

- [ ] Real ingest into archive (staging area)
...
- [ ] rename puppet-dci2 (puppet-tada, puppet-astro, puppet-noao)
