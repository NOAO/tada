...
Modifying in place will change checksum which may be used by irods and
data-queue.  Work-flow needs some enhancements to allows for:
1. files (checksum) changes
2. ability to simply delete a file
